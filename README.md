# Orders of deparment of School Education and Sports Department Government of Maharashtra
...
1. [mahedu2024-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahedu2024-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
```
git clone https://github.com/orgpedia/mahedu2024.git
```
